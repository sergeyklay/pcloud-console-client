...
/// \file bridge.hpp
/// \brief Represent legacy console application.
/// \deprecated Will be replace in the future with App class.

#ifndef PCLOUD_CLI_BRIDGE_HPP_
#define PCLOUD_CLI_BRIDGE_HPP_
